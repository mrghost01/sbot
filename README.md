# [Last version of Avira Bot](https://telegram.me/AviraTeam)
...
**An advanced and powerful administration bot based on [SEEDTEAM/TeleSeed](https://github.com/SEEDTEAM/TeleSeed) licensed under the [GNU Affero General Public License](https://github.com/SEEDTEAM/TeleSeed/blob/master/LICENSE)**.
# Features
...
## Commands
Avira Bot has several commands that are only usable at certain ranks.
...
| [#!/]maxwarn [setting] | set max warn. | Y | Y |
...
cd $HOME
git clone https://github.com/AviraTeam/Avira-MaxWarn.git
cd Avira-MaxWarn
chmod +x launch.sh
./launch.sh install
...
[Mohammad Mahdi](https://github.com/hmon) ([Telegram](https://telegram.me/MohammadArak))

[MosioPoker](https://github.com/imandaneshi) ([Telegram](https://telegram.me/MosioPoker))
