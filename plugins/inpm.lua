...
text = "با سلام\nبه بخش چت خصوصی ربات تیم خوش آمدید \n➖➖➖➖➖‏\nبرای ارتباط مستقیم با ادمین ها پیام خود را همینجا ارسال کنید تا در اسرع وقت پیگیری  و پاسخ دریافت کنید.\n➖➖➖➖➖\nبرای خرید گروه یا پلاگین یا سورس  و ...  دو راه دارید.\n1 - به پی وی \n@MrUnusual\nرفته و درخواست دهید.\n➖➖➖➖➖\n2- درخواست خود را همینجا در  قالب یک پیام شامل :\n\nموضوع :\nمتن :\nیک راه ارتباطی :\n\nارسال کرده و منتظر بمانید تا به درخواست شما رسیدگی شود.\n➖➖➖➖➖‏\nبا تشکر"     	return text
    end
